"""Kornia-derived 2D/3D geometric transforms with optional JIT compilation.

Angle, coordinate, quaternion, rotation-matrix, and axis-angle conversions
used throughout GEAR-SONIC training and inference. Many functions are
conditionally wrapped with torch.jit.script (controlled by the
USE_JIT_TORCH_TRANSFORM env var) for performance.
"""
