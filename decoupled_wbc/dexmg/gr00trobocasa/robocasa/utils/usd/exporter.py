...
class USDExporter:
    ...
    def _load_cameras(self):
        ...
        if self.camera_names is not None:
            for name in self.camera_names:
                self.usd_cameras.append(component_module.USDCamera(stage=self.stage, obj_name=name))
    ...
    def _update_cameras(
        ...
        for i in range(len(self.usd_cameras)):
            ...
            self.renderer.update_scene(data, scene_option=scene_option, camera=camera_name)
    ...
    def add_light(
        ...
        if light_type == "sphere":
            ...
            new_light = component_module.USDDomeLight(stage=self.stage, obj_name=str(objid))
    ...
    def save_scene(self, filetype: str = "usd"):
        ...
        if self.verbose:
            print(
                termcolor.colored(f"Completed writing frame_{self.frame_count}.{filetype}", "green")
            )
